...
def _call_ocr_space(img_bgr: np.ndarray) -> str:
...
def run_pipeline(image_bytes: bytes, model_name: str = "model.pt", conf: Optional[float] = None, padding: Optional[int] = None):
